...
const TambahWfaTanggalModal = (props) => {
  ...
  const tambahAction = async () => {
    ...
    try {
      await axios.post(
        `${import.meta.env.VITE_SIMPEG_REST_URL}/wfa-tanggal`,
        {
  ...
  return (
    <CModal visible={props.visible} onClose={() => props.setVisible(false)}>
      <CModalHeader onClose={() => props.setVisible(false)}>
        <CModalTitle>Tambah WFA - Tanggal</CModalTitle>
      </CModalHeader>
...
TambahWfaTanggalModal.propTypes = {
  added: PropTypes.func,
  visible: PropTypes.bool.isRequired,
  setVisible: PropTypes.func,
}

export default TambahWfaTanggalModal
